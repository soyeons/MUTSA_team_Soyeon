...
//     //     })
//     // });
//     // console.log('dsd'+JSON.stringify(postList));
//     return (
//         <div id="center">
//             <nav><Navbar/></nav>
//             <div>
...
//                                         <EachPost postID={element.postID} title={element.title} writer={element.author} writeday='' counts=''/>
//                                     ))}                                        
//                             </table>
                        ...
                        <div className="PostList">
                            ...
                            <table>
                                <thead>
                                    ...
                                    {postList.map((element)=>(
                                        <EachPost postID={element.id} title={element.title} writer={element.userId} writeday={element.writeday} counts={element.counts}/>
                                    ))}                                        
                            </table>
                            <div className='pageNum'>
                                <button onClick={()=>{
