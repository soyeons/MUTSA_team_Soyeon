							...
							<form className='tagSearchForm'>
								...
								<div className='tagContainer'>
									...
									<button type='button' onClick={() => btnActivate(2, 1)}>
										<p className='emogi'>💚 😌 🏝</p>
										<div className={'mainThemetext' + (checks1 === 2 ? ' active' : '')}>
											<h1>
												잔잔하고
												<br />
												힐링이 되는
									...
									<button type='button' onClick={() => btnActivate(3, 1)}>
										<p className='emogi'>🎶 🌈 🫶</p>
										<div className={'mainThemetext' + (checks1 === 3 ? ' active' : '')}>
											<h1>
												스트레스는 날려버려 +
												<br />
												잔잔하고 힐링이 되는
									...
									<button type='button' onClick={() => btnActivate(1, 2)}>
										<p className='emogi'>✨ 🎸 💃</p>
										<div className={'mainThemetext' + (checks2 === 1 ? ' active' : '')}>
											<h1>
												그루브 타며
												<br />
												비트에 온 몸을 맡겨
									...
									<button type='button' onClick={() => btnActivate(2, 2)}>
										<p className='emogi'>🎈 🎧 🌆</p>
										<div className={'mainThemetext' + (checks2 === 2 ? ' active' : '')}>
											<h1>
												내 감성을 책임질
												<br />
												인디 음악
									...
									<button type='button' onClick={() => btnActivate(3, 2)}>
										<p className='emogi'>🎸 🎤 🎧</p>
										<div className={'mainThemetext' + (checks2 === 3 ? ' active' : '')}>
											<h1>
												힙합? 인디?
												<br />
												장르를 가릴 수 없어
