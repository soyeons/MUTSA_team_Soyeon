				...
				<div className='YellowSquareCheck'>
					<div className='PostListCheck'>
						...
						<div className='placeQ'>
							...
							<div className='checkBtn'>
								<button className={`checkBtns ${tab2 === 0 ? 'active' : ''}`} onClick={() => setTab2(0)}>
									힙합 / 알앤비 / 락
								</button>
								<button className={`checkBtns ${tab2 === 1 ? 'active' : ''}`} onClick={() => setTab2(1)}>
									인디 어쿠스틱 / 인디 밴드
								</button>
								<button className={`checkBtns ${tab2 === 2 ? 'active' : ''}`} onClick={() => setTab2(2)}>
									워터밤 ....?
								</button>
							</div>
						</div>
						<div className='placeQ'>
							...
							<div className='checkBtn'>
								<button className={`checkBtns ${tab3 === 0 ? 'active' : ''}`} onClick={() => setTab3(0)}>
									티켓팅 치열해요
								</button>
								<button className={`checkBtns ${tab3 === 1 ? 'active' : ''}`} onClick={() => setTab3(1)}>
									그냥 그래요
								</button>
								<button className={`checkBtns ${tab3 === 2 ? 'active' : ''}`} onClick={() => setTab3(2)}>
									티켓팅 식은 죽 먹기
								</button>
							</div>
						</div>
